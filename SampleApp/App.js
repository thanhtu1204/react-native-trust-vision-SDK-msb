...
const App: () => React$Node = () => {
  const onPressGetLogFilePaths = async () => {
    const logFilePaths = await RNTrustVisionRnsdkFramework.getLogFilePathsWithResolver();
    console.log('LogFilePaths', logFilePaths);
  };
  ...
  const onPress = async () => {
    try {
      await RNTrustVisionRnsdkFramework.initialize(
        ...
        '4df5f9b9-f34d-4ffa-829f-aa4889bc9fe5',
        'dQDfxkVYXfAxpdReqdOd1zJP4pJ088Y7',
        'https://tv-testing.trustingsocial.com/api',

        // '28280948-e059-4a88-a5d9-b7268aca595f',
        // 'rEa1Bh3ZPaRUdEgPPLBlltF6ABf4CTvf',
        // 'https://vn-vision-msb-reatogar.trustingsocial.com/api',
        null,
        true,
        // true
      );
  ...
  return (
    <>
      ...
      <SafeAreaView>
        ...
        <Button title={'Get Logs'} onPress={onPressGetLogFilePaths} />
        <ScrollView
